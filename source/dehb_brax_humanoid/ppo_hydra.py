...
def hydra_launcher(cfg, log) -> float:
    cfg.algorithm.model_kwargs['num_evals'] = 10 // (50000001 // cfg.algorithm['num_timesteps'])
    ...
    def progress(num_steps, metrics):
        ...
        if cfg.algorithm.eval:
            run.log({"rollout/episode_reward": metrics["eval/episode_reward"]}, step=num_steps)
